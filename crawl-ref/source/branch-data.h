...
const Branch branches[NUM_BRANCHES] =
{
    ...
    { BRANCH_TEMPLE, BRANCH_DUNGEON, 4, 7, 1, 5,
      ...
      "Temple", "the Ecumenical Temple", "Temple", "寺",
      nullptr,
      LIGHTGREY, BROWN,
      'T', 0 },
    ...
    { BRANCH_ORC, BRANCH_DUNGEON, 9, 12, 4, 8,
      ...
      "Orcish Mines", "the Orcish Mines", "Orc", "オ",
      nullptr,
      BROWN, BROWN,
      'O', 4 },
    ...
    { BRANCH_ELF, BRANCH_ORC, 3, 4, 3, 15,
      ...
      "Elven Halls", "the Elven Halls", "Elf", "エ",
      nullptr,
    ...
    { BRANCH_DWARF, BRANCH_ELF, -1, -1, 0, 17,
      ...
      "Dwarven Hall", "the Dwarven Hall", "Dwarf", "ド",
      nullptr,
      BROWN, BROWN,
      'K', 0 },
#endif
    ...
    { BRANCH_LAIR, BRANCH_DUNGEON, 8, 11, 8, 10,
      ...
      "Lair", "the Lair of Beasts", "Lair", "獣",
      nullptr,
      GREEN, BROWN,
      'L', 4 },
    ...
    { BRANCH_SNAKE, BRANCH_LAIR, 3, 6, 5, 15,
      ...
      "Snake Pit", "the Snake Pit", "Snake", "蛇",
      nullptr,
      LIGHTGREEN, YELLOW,
      'P', 0 },
    ...
    { BRANCH_SPIDER, BRANCH_LAIR, 3, 6, 5, 15,
      ...
      "Spider Nest", "the Spider Nest", "Spider", "蜘",
      nullptr,
      BROWN, YELLOW,
      'N', 0 },
    ...
    { BRANCH_SLIME, BRANCH_LAIR, 6, 8, 6, 17,
      ...
      "Slime Pits", "the Pits of Slime", "Slime", "ス",
      nullptr,
      GREEN, BROWN,
      'M', -5 },
    ...
    { BRANCH_BLADE, BRANCH_VAULTS, 3, 4, 1, 21,
      ...
      "Hall of Blades", "the Hall of Blades", "Blade", "刃",
      nullptr,
      LIGHTGREY, BROWN,
      'B', -7 },
#endif
    ...
    { BRANCH_TOMB, BRANCH_CRYPT, 3, 3, 3, 21,
      ...
      "Tomb", "the Tomb of the Ancients", "Tomb", "廟",
      nullptr,
      BROWN, BROWN,
      'W', -10 },
    ...
    { BRANCH_VESTIBULE, NUM_BRANCHES, 27, 27, 1, 27,
      ...
      "Hell", "the Vestibule of Hell", "Hell", "獄",
    ...
    { BRANCH_DIS, BRANCH_VESTIBULE, 1, 1, 7, 28,
      ...
      "Dis", "the Iron City of Dis", "Dis", "鉄",
      nullptr,
      CYAN, BROWN,
      'I', 0 },
    ...
    { BRANCH_FOREST, BRANCH_VAULTS, 2, 3, 5, 19,
      ...
      "Forest", "the Enchanted Forest", "Forest", "森",
      nullptr,
      BROWN, BROWN,
      'F', 0 },
#endif
